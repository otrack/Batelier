...
class PMPhase1A extends PMessage implements Cloneable{
    ...
    public PMPhase1A(String streamName, int instance, int ts, int p_id, int swid) {
        super(PHASE1_A,streamName,instance,swid);
        this.timestamp = ts;
        this.proposerId = p_id;
    }
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeInt(proposerId);
    }
    
    public Object clone(){
    	PMPhase1A m = (PMPhase1A)super.clone();
    	m.timestamp= this.timestamp;
    	m.proposerId = this.proposerId;
    	return m;
    }
}
