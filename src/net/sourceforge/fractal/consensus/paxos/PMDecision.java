...
class PMDecision extends PMessage implements Cloneable{
    private static final long serialVersionUID = Messageable.FRACTAL_MID;
    
    public PMDecision(){}
    
    public PMDecision(String streamName, int instance, Serializable decision, int swid) {
        super(DECISION, streamName, instance, swid);
        this.serializable = decision;
    }
