...
public interface LogFilter extends Serializable{
    public LogEntry[][] filter(FractalManager loader, int accSwId);

    public int getFirstInstance();

    public int getNumberOfRm();

    public String getStreamName();

    public LogEntry filterEntry(String streamName, LogEntry logEntry);

    public int getIndex(String streamName);
}
